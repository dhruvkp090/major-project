...
def post():
    if request.method == 'POST':
        ...
        winner_team = predict(home_team, away_team, city,
                              toss_winner, toss_decision).__str__()
        ...
        flash("Match Prediction between " + home_team_name + " and " +
              away_team_name + " is higher for: " + winner_team)
    return render_template('index.html')
